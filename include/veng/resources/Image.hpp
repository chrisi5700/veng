...
{
	 public:
	/// Allocate a device-local 2D image (1 mip, 1 layer, 1 sample) and a matching
	/// full-subresource view. `aspect` selects the view aspect (color/depth).
	...
	Image(vma::Allocator allocator, vk::Device device, vk::Image image, vma::Allocation allocation, vk::ImageView view,
		  vk::Format format, vk::Extent2D extent) noexcept;
